...
const menuItems = [
  { id: 1, label: "90주년 스토리", sub: "Main Timeline", path: "/maintimeline" },
              ...
              <nav className="flex flex-col space-y-6">
                {menuItems.map((item, index) => (
                  ...
                  >
                    ...
                    <span className="text-sm font-normal text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity ml-4 tracking-normal">
                      {item.sub}
                    </span>
                  </motion.div>
                  </Link>
