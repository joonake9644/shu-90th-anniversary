...
import { createHistoryChapter } from '@/lib/firestore/admin/history';

export default function NewHistoryChapterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setLoading(true);
      await createHistoryChapter(formData);
      alert('챕터가 추가되었습니다!');
      ...
      <header className="bg-gray-900 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-amber-500">새 챕터 추가</h1>
            <Link
          ...
          <div className="bg-gray-900 border border-white/10 rounded-lg p-6 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 bg-gray-800 border border-white/10 rounded-lg text-white"
                placeholder="예: 어둠 속에서 피어난 희망의 등불"
              />
            </div>
